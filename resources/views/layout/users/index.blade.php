...
<body class="overflow-hidden">
 ...
 <header>
        ...
        <img  onclick="window.location.href='{{ url('/') }}'" src="{{ asset('favicon/logo.jpg?v=1.1') }}" alt="Logo" class="h-50 pc-pointer">
         <div onclick="
...
<section onclick="HideSlideUp()" class="slideup">
  <div onclick="event.stopPropagation()" class="child bg-secondary-dark">@yield('slideup_child')</div>
   ...
   <img src="{{ asset('favicon/logo-white.jpg?v=1.1') }}" alt="" class="grid-full w-100 pc-m-x-auto">
   <span class="font-1 grid-full">
    Together We Earn, Together We Grow...
