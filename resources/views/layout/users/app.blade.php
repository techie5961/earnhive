...
<body class="overflow-hidden">
  ...
  <header style="z-index:3000" class="pos-sticky average c-white bg p-10 top-0 left-0 right-0 bottom-0 row align-center g-10">
        ...
        <img src="{{ asset('favicon/logo.jpg?v=1.3') }}" alt="Logo" class="h-30 pc-pointer" onclick="window.location.href='{{ url('/') }}'">
            ...
            <div class="nav-links flex-auto p-10 bg-inherit w-full column">
              {{-- NEW NAV LINK --}}
                ...
                <div class="nav-group searchable nav-link c-white w-full column">
                  ...
                  <div class="icon-group">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="CurrentColor" height="20" width="20"><path d="M176,16H80A24,24,0,0,0,56,40V216a24,24,0,0,0,24,24h96a24,24,0,0,0,24-24V40A24,24,0,0,0,176,16ZM128,72a12,12,0,1,1,12-12A12,12,0,0,1,128,72Z"></path></svg>
